...
const expectedColumns = {
  ...
  onibus_operacionais: ["venda_ordem"],
  quartos_hospedagem: ["id", "lote_id", "pacote_id", "nome", "genero", "capacidade", "observacoes", "ativo", "criado_por", "criado_em", "atualizado_em"],
...
try {
  ...
  if (migrationCount < 15) throw new Error(`Histórico Drizzle incompleto: ${migrationCount}/15 migrations`);
