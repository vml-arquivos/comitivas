...
interface ContratoLinha {
  ...
  operacao?: { onibus_nome: string; poltrona: number; ponto_embarque?: string | null } | null;
...
const FORMA_LABEL: Record<string, string> = { pix: 'PIX à vista', boleto: 'Boleto parcelado', credito: 'Cartão de crédito' };
