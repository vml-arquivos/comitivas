...
export default function GatewayPagamento() {
  ...
  const salvar = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMensagem('Endpoints e parâmetros salvos. Segredos continuam somente no Coolify/runtime.');
    } catch (err: any) {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="flex items-center justify-between gap-4">
        <div><p className="text-xs font-bold uppercase tracking-[0.16em] text-primary">DEV · Configuração operacional</p><h1 className="text-3xl font-bold text-secondary">Gateway de pagamento</h1><p className="mt-1 text-sm text-gray-500">O painel exibe status e parâmetros não sensíveis. Credenciais, certificados e chaves são carregados somente do Coolify/runtime.</p></div>
