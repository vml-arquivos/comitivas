...
type Disponibilidade = 'disponivel' | 'ultimas_vagas' | 'esgotado' | 'configuracao_pendente';
...
function disponibilidadeLabel(valor: Disponibilidade) {
  return valor === 'esgotado' ? 'Esgotado' : valor === 'configuracao_pendente' ? 'Em configuração' : valor === 'ultimas_vagas' ? 'Últimas vagas' : 'Disponível';
}
