...
function disponibilidadeOferta(oferta: Oferta) {
    ...
    <div className="min-h-screen bg-[#F8F5EF] text-[#182D3B]">
      ...
      <section id="hospedagem" className="scroll-mt-28 bg-[#F8F5EF] py-20 sm:py-24">
        <div className="mx-auto max-w-[1280px] px-5 sm:px-8 lg:px-10">
          ...
          {isLoading && (
            <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-2" aria-label="Carregando pacotes">
