...
export const eventos = pgTable("eventos", {
  ...
  destaque_titulo: varchar("destaque_titulo", { length: 160 }),
  destaque_texto: text("destaque_texto"),
  informacoes_praticas: text("informacoes_praticas"),
  atracoes_programacao: text("atracoes_programacao"),
...
export const lotes = pgTable("lotes", {
  ...
  operacional_interno: boolean("operacional_interno").notNull().default(false),
  data_inicio: timestamp("data_inicio").notNull(),
  data_fim: timestamp("data_fim").notNull(),
  data_embarque: timestamp("data_embarque"),
  data_retorno: timestamp("data_retorno"),
...
export const pacotes = pgTable("pacotes", {
  ...
  formas_contratacao: jsonb("formas_contratacao").notNull().default(["onibus_hospedagem"]),
  ...
  destaque_titulo: varchar("destaque_titulo", { length: 160 }),
  destaque_subtitulo: varchar("destaque_subtitulo", { length: 255 }),
  destaque_texto: text("destaque_texto"),
  ativo: boolean("ativo").default(true),
  criado_em: timestamp("criado_em").defaultNow().notNull(),
  atualizado_em: timestamp("atualizado_em").defaultNow().notNull(),
